...
class SawyerSequenceSplitDataset(D4RLSequenceSplitDataset):
    ...
    def __init__(self, data_dir, data_conf, phase, resolution=None, shuffle=True, dataset_size=-1):
        self.phase = phase
        # self.data_dir = '~/.d4rl/datasets/sawyer_primitive_distilled.npy'
        ...
        path = osp.expanduser('~/.d4rl/datasets/sawyer_primitive_distilled.npy')
        if osp.isfile(path):
